...
public class FCICRCommand implements CommandExecutor {
	...
	final private ItemStack WART = new ItemStack(372);
	@SuppressWarnings("deprecation")
	final private ItemStack WITHER = new ItemStack(397, 1, (short) 1);
									...
									if (args[0].equalsIgnoreCase("6")) {
										...
										if (args[0].equalsIgnoreCase("7")) {
											...
											if (args[0].equalsIgnoreCase("8")) {
												...
												inv.setItem(11, WART);
												inv.setItem(13, WART);
												inv.setItem(15, Schwertgenerator.getSlowT2(p));
												p.openInventory(inv);
											} else {
